 ...
 * ```
 */
export class TasklistRESTClient {
   ...
   */
  constructor(
    private authApiClient: TasklistAuthProvider,
    options: {
    ...
    const baseUrl = authApiClient.getBaseUrl();
  ...
  private async getHeaders() {
    const authHeader = await this.authApiClient.getHeaders({
